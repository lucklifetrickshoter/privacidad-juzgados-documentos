...
(function () {
     ...
     */
    const CAPS_EXCLUDE = /^(?:JUZGADO|TRIBUNAL|PODER|JUDICIAL|SUPREMO|CÓDIGO|CONSTITUCIÓN|ESTADO|NACIÓN|REPÚBLICA|GOBIERNO|SECRETARÍA|IMSS|ISSSTE|SAT|CURP|RFC|NSS|NO|ART|FRACC|CAP|SEC|NUM|INC|PÁR|VS|ETC|S\.A|S\.DE|S\.C|A\.C|A\.B|BANCO|GRUPO|INSTITUTO|UNIVERSIDAD|COLEGIO)/.test;
